...
import com.example.gotering_fix_banget.Data.Product
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for (product in productsList) {
            ...
            productLayout.setOnClickListener {
                val intent = Intent(requireActivity(), com.example.gotering_fix_banget.Activity.TambahMenuActivity::class.java)
        ...
        checkout_button.setOnClickListener {
            ...
            if (orderName.isNotEmpty() && orderDeliver.isNotEmpty()) {
                ...
                val intent = Intent(
                    requireActivity(),
                    com.example.gotering_fix_banget.Activity.KonfirmasiActivity::class.java
                )
