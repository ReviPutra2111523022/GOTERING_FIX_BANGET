...
import com.example.gotering_fix_banget.Data.Order
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for (order in ordersList) {
            ...
            productLayout.setOnClickListener {
                val intent = Intent(requireActivity(), com.example.gotering_fix_banget.Activity.TransaksiActivity::class.java)
